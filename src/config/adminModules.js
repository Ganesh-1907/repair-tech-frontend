const adminModules = [
  {
    ...
    defaultOpen: true,
    roles: ['admin', 'sales', 'frontOffice', 'caAdmin'],
    children: [
      {
        id: 'admin-dashboard',
        label: 'Dash Board',
        path: '/admin/dashboard',
        roles: ['admin', 'sales', 'frontOffice'],
    ...
    children: [
      {
        id: 'rental-plans',
        label: 'Rental Plans',
        path: '/admin/rental/plans',
        roles: ['admin'],
        description: 'Define and manage rental plan structures and customer-ready offerings.',
        actions: ['Add', 'View List', 'Manage'],
      },
      {
        id: 'rental-customers',
  ...
  },
  {
    ...
    label: 'My Account',
    icon: 'User',
    roles: ['staff', 'sales', 'frontOffice'],
    children: [
      {
        id: 'staff-portal-account-dashboard',
        label: 'Dashboard',
        path: '/admin/staff-portal',
        exact: true,
        roles: ['sales', 'frontOffice'],
        description: 'Personal dashboard with attendance, payments, and activity.',
        actions: ['View List'],
      },
      {
