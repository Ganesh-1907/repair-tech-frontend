    ...
    children: [
      {
        id: 'amc-dashboard',
        label: 'AMC Dashboard',
        path: '/admin/amc/dashboard',
        description: 'Business analytics for AMC contracts, revenue, costs, and technician performance.',
        actions: ['View List'],
      },
      {
        id: 'amc-plans-customers',
        label: 'AMC Plans & Customers',
        path: '/admin/amc/plans-customers',
        description: 'Manage AMC service packages and customer agreements in a single tabbed view.',
        actions: ['Add', 'View List', 'Manage'],
      },
      {
        ...
        description: 'Enroll and track devices covered under active AMC agreements.',
        actions: ['Add', 'View List', 'Manage'],
      },
      {
        ...
        description: 'Automated service scheduling, visit tracking, and visit notifications.',
        actions: ['View List', 'Manage'],
      },
      {
        id: 'amc-billing-renewals',
        label: 'AMC Billing & Renewals',
        path: '/admin/amc/billing-renewals',
        description: 'Manage AMC invoicing, payment tracking, and automated renewal reminders.',
        actions: ['Add', 'View List', 'Manage'],
      },
      {
        id: 'amc-reports',
        label: 'AMC Reports',
        path: '/admin/amc/reports',
        description: 'Detailed analytics on profitability, conversion, and service ticket volume.',
        actions: ['View List'],
      },
    ],
  },
