...
const AMCPlansPage = () => {
  ...
  const fetchPlans = async () => {
    ...
    try {
      ...
      setError('Failed to load AMC plans. Is the backend running?');
    } finally {
      setLoading(false);
    }
  };
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        if (!cancelled) setError('Failed to load AMC plans. Is the backend running?');
      } finally {
        ...
        <div className="modal-body">
          ...
          <div className="form-group">
            ...
            <textarea className="form-input" value={formData.features}
              ...
              placeholder={`4 preventive visits/yr\nPriority response\nSoftware & driver support\nDiscount on parts`}
