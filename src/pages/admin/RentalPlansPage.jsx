...
const COLLECTION = 'rentalPricingPlans';
...
const RentalPlansPage = () => {
  ...
  const fetchPlans = useCallback(async () => {
    ...
    try {
      ...
      setError('Failed to load rental plans. Is the backend running?');
    } finally {
      setLoading(false);
    }
  }, []);
        ...
        <div className="modal-body">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            <div className="form-group">
              ...
              <input className="form-input" value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })} placeholder="e.g. Basic Rental" />
            </div>
            <div className="form-group">
