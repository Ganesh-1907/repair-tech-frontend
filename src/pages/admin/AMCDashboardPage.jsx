    ...
    >
      ...
      <header className="dashboard-header">
        <div className="header-left">
          <h1 style={{ fontSize: '26px', fontWeight: 900, margin: 0 }}>AMC Dashboard</h1>
          <p style={{ fontSize: '13px', color: '#64748b', margin: 0 }}>Executive overview of AMC revenue, renewals, and service pipeline.</p>
        </div>
        <div className="header-actions">
          <div className="search-input-wrapper">
            <Search size={18} style={{ position: 'absolute', left: '14px', top: '12px', color: '#94a3b8' }} />
            <input type="text" placeholder="Search AMC data..." />
          </div>
          ...
          <div className="flex items-center gap-3 bg-white px-3 py-1.5 rounded-xl border border-slate-100 shadow-sm">
            ...
            <div className="pr-1">
              ...
              <p className="text-[8px] font-bold text-slate-400 uppercase mt-0.5">AMC Lead</p>
            </div>
          </div>
        </div>
      </header>
