...
const RentalIndividualAgreementPage = () => {
  ...
  const [form, setForm] = useState({
    ...
    agreementNo: `RIA-${new Date().getFullYear()}-${Math.floor(1000 + Math.random() * 9000)}`,
    customerName: '',
    contactPerson: '',
    customerAddress: '',
    ...
    validity: '12 Months',
    scope: ['Device rental coverage', 'Basic maintenance support', 'Remote support assistance'],
        ...
        <div className="document-paper">
          ...
          <div className="paper-body">
            <div className="info-grid">
              <div className="info-block"><strong>BILL TO:</strong><p className="client-name">{form.customerName || '-'}</p><p>{form.contactPerson || '-'}</p><p>{form.customerAddress || '-'}</p></div>
  ...
  return (
    <div className="document-view-container rental-workflow-page">
      <div className="document-header">
        ...
        <h2 style={{ margin: 0, fontSize: '18px', fontWeight: 700 }}>Individual Agreement Settings</h2>
