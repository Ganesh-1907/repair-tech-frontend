...
const CMCViewPage = () => {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        const data = await api.get('cmcContracts', id);
        setContract(data);
      } catch (err) {
        console.error('Failed to load CMC contract:', err);
      } finally {
        setLoading(false);
      }
    };
  ...
  if (loading) return <div className="view-page-loading">Loading CMC details...</div>;
  if (!contract) return <div className="view-page-error">Contract not found.</div>;

  const details = contract.cmcDetails || {};
    ...
    <div className="amc-new-page">
      ...
      <div className="amc-new-page-body">
        ...
        <div className="amc-form-card">
          ...
          <div className="amc-form-card-body">
            <div className="view-grid">
              <DataRow label="CMC ID" value={contract.id || contract.contractId} />
              <DataRow label="CMC Plan" value={details.planName} />
