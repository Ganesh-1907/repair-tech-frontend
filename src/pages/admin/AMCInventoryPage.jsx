      ...
      <div className="main-grid" style={{ gridTemplateColumns: '1fr 1fr', gap: 24 }}>
        ...
        <div className="agreement-preview-container">
          <div className="agreement-document" ref={printRef}>
            ...
            <div className="agreement-footer"><p>Generated by RepairBoy Enterprise — AMC Management System</p></div>
          </div>
        </div>
      </div>
    </div>
  ...
  const handleEmail = async () => {
    ...
    try {
      ...
      const res = await apiClient.post('/email/amc-agreement', {
        ...
        startDate: currentCustomer.start,
        endDate: currentCustomer.expiry,
