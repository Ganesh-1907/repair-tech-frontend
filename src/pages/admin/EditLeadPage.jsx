    ...
    <div style={{ padding: '24px 28px' }}>
      ...
      <form onSubmit={handleSubmit} className="card" style={{ padding: '28px 32px' }}>
        <div className="form-grid" style={{ gridTemplateColumns: 'repeat(3, minmax(0, 1fr))' }}>
          ...
          <div className="form-group"><label htmlFor="edit-service-type">Service Type</label><select id="edit-service-type" value={form.serviceType} onChange={(e) => updateForm('serviceType', e.target.value)}><option value="">Select Service Type</option>{serviceTypeOptions.map((item) => <option key={item} value={item}>{item}</option>)}</select>{errors.serviceType && <span className="form-error">{errors.serviceType}</span>}</div>
          <div className="form-group"><label htmlFor="edit-source">Source</label><select id="edit-source" value={form.source} onChange={(e) => updateForm('source', e.target.value)}><option value="">Select Source</option>{sourceOptions.map((item) => <option key={item} value={item}>{item}</option>)}</select>{errors.source && <span className="form-error">{errors.source}</span>}</div>
          ...
          <div className="form-group"><label htmlFor="edit-device">Device</label><select id="edit-device" value={form.device} onChange={(e) => updateForm('device', e.target.value)}><option value="">Select Device</option>{deviceOptions.map((item) => <option key={item} value={item}>{item}</option>)}</select></div>
