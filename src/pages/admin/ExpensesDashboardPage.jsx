  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center mb-10">
        <div>
          <h2 className="text-3xl font-black tracking-tight text-slate-900">Expense <span className="text-indigo-600">Intelligence</span></h2>
          <p className="text-slate-500 font-medium mt-1">Read-only summary of global expenditures and financial trends.</p>
        </div>
