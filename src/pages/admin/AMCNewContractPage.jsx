...
// Reuses existing field components — sub-type can be any device type except Total Maintenance
...
const AMCNewContractPage = () => {
  ...
  const [existingAmcDetails, setExistingAmcDetails] = useState({});
  ...
  const validate = () => {
    ...
    if (!form.amcPlan) errs.amcPlan = 'Select an AMC plan';
      ...
      <div className="amc-new-page-body">
        ...
        <div className="amc-form-card card-contract">
          ...
          <div className="amc-form-card-body">
            <div className="form-row-2">
              <div className="form-group">
                <label>AMC ID (Auto-generated)</label>
                <input
                  className="form-input"
              ...
              <div className={`form-group${errors.amcPlan ? ' has-error' : ''}`}>
                <label>AMC Plan *</label>
                <select
                  className="form-select"
                  value={form.amcPlan}
                  onChange={e => { setForm(f => ({ ...f, amcPlan: e.target.value })); setErrors(p => ({ ...p, amcPlan: undefined })); }}
                >
                ...
                {errors.amcPlan && <span className="field-error">{errors.amcPlan}</span>}
              </div>
            </div>
            <div className="form-row-2">
...
export default AMCNewContractPage;
